	...
	public void draw() {
		if (this.health > 0) {
			if (this.wobble) {
				...
				this.sprite.draw((this.x - Gameplay.getCameraX() + size) * Gameplay.GLOBAL_GAME_SCALE,
						(this.y - Gameplay.getCameraY() + size) * Gameplay.GLOBAL_GAME_SCALE, scale * Gameplay.GLOBAL_GAME_SCALE);
			} else {
