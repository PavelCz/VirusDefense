	...
	public void draw() {
		if (this.health > 0) {
			if (this.wobble) {
				...
				this.sprite.draw((this.x - Gameplay.getCameraX() + size) * Gameplay.CURRENT_GAME_SCALE,
						(this.y - Gameplay.getCameraY() + size) * Gameplay.CURRENT_GAME_SCALE, scale * Gameplay.CURRENT_GAME_SCALE);
			} else {
